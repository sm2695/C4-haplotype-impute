...
Input="/home/susmita/kasp/kasp/Imputation/C4/vcf_files/P1858_raw/raw/*.vcf.gz"
for f in $Input
do 
echo "Processing $f file..."
vcf="$f"
out="/home/susmita/kasp/kasp/Imputation/C4/out/$(basename -s .clean.dedup.recal.bam.merged.annotated.vcf.gz $f)"
build=37
